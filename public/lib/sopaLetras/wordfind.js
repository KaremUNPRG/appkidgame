...
(function () {
    ...
    var WordFind = function () {
      ...
      * @param {[String]} trampas: List of words to include in the puzzle

      * @api public
      */
            newPuzzle: function (words, settings, trampas) {
                var wordList,
                    wordWithTrampa,
                    puzzle,
                    attempts = 0,
                ...
                // trampas.forEach((item) => {
                //   words.push(item);
                // });
                // console.log("puzzle", puzzle);
                wordWithTrampa = [];
                words.forEach((el) => {
                    wordWithTrampa.push(el);
                });
                ...
                wordList = wordWithTrampa.slice(0).sort(function (a, b) {
