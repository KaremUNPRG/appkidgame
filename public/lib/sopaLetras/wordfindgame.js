...
(function (document, $, wordfind) {
    ...
    var WordFindGame = function () {
        ...
        var drawPuzzleRandom = function (puzzle) {
            // console.log("puzzzle", puzzle);
        ...
        return {
             ...
             * @param {[String]} trampas: The words to add to the puzzle
             ...
             */
            create: function (words, trampas, puzzleEl, wordsEl, options) {
                wordList = words.slice(0).sort();

                // console.log("wordsEl", wordsEl);
                var puzzle = wordfind.newPuzzle(words, options, trampas);
                // puzzle[0][0] = "A";
                // console.log("puzzleCreate", puzzle);
                drawPuzzleRandom(puzzle);
